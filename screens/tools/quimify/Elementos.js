  ...
  const tabla = [
    {
      periodo: [
        ...
        { elemento: '', simbolo: '', tipo: '', numero: 0 },
        { elemento: '', simbolo: '', tipo: '', numero: 0 },
        { elemento: 'Helio', simbolo: 'He', tipo: 'Gas Noble', numero: 2 },
      ],
    },
    {
      periodo: [
  ...
  return (
    <ScrollView>
     <ScrollView
      ...
      >
        <View>
          <Periodo periodo={tabla[0].periodo} />
          <Periodo periodo={tabla[1].periodo} />
          <Periodo periodo={tabla[2].periodo} />
          <Periodo periodo={tabla[3].periodo} />
          <Periodo periodo={tabla[4].periodo} />
          <Periodo periodo={tabla[5].periodo} />
          <Periodo periodo={tabla[6].periodo} />
          <View className='ml-[231px] mt-6'>
            <Periodo periodo={tabla[7].periodo} />
            <Periodo periodo={tabla[8].periodo} />
          </View>
